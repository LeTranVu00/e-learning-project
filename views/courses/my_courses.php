...
<?php if (empty($courses)): ?>
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-12 text-center"
        data-aos="fade-up">
        <div
            class="w-24 h-24 bg-yellow-50 dark:bg-yellow-900/20 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <p class="text-gray-500 dark:text-gray-400 mb-6">Hãy khám phá các khóa học hấp dẫn của chúng tôi và bắt đầu ngay hôm
            nay!</p>
        <a href="?action=courses"
            class="inline-flex items-center gap-2 bg-primary hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
...
<?php else: ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl dark:hover:shadow-gray-900/30 transition-all duration-300 flex flex-col group hover:-translate-y-2"
                ...
                <div class="relative h-48 bg-gray-200 dark:bg-gray-700 overflow-hidden">
                    <img src="<?= htmlspecialchars($course['thumbnail'] ?? 'https://placehold.co/600x400/f59e0b/white?text=Course+Image') ?>"
                        alt="Course Thumbnail" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                    <div
                    ...
                    <!-- Enrolled Badge -->
                    <div
                        class="absolute top-4 right-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm px-3 py-1.5 rounded-full text-xs font-bold text-green-600 dark:text-green-400 shadow-sm flex items-center gap-1.5">
                    ...
                    <?php if ($course['progress_percent'] == 100): ?>
                        <div
                            class="absolute top-4 left-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1.5">
                ...
                <div class="p-6 flex-grow flex flex-col">
                    <h3
                        class="text-xl font-bold text-gray-900 dark:text-white mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="text-sm font-bold <?= $course['progress_percent'] == 100 ? 'text-green-500' : 'text-primary' ?>">
                        ...
                        <a href="?action=learn&id=<?= $course['id'] ?>"
                            ...
                            <?php else: ?>
                                <i class="fa-solid fa-arrow-right mr-1 group-hover/btn:translate-x-1 transition-transform"></i> Vào
                                học tiếp
                            <?php endif; ?>
                        </a>
                    </div>
    ...
    <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6" data-aos="fade-up">
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 text-center shadow-sm">
            <div
                class="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-xl flex items-center justify-center mx-auto mb-3">

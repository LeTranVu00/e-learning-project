...
<section class="pt-32 pb-16 bg-gradient-to-br from-primary/10 via-yellow-500/5 to-transparent relative overflow-hidden" data-aos="fade-down">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h1 class="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Khôi phục <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-yellow-500">Mật khẩu</span></h1>
        <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Nhập email của bạn để nhận liên kết đặt lại mật khẩu</p>
    </div>
</section>
        ...
        <div class="glass dark:glass-dark rounded-3xl p-8 sm:p-10 shadow-2xl border border-gray-100 dark:border-gray-800 relative z-10" data-aos="zoom-in" data-aos-delay="100">
            <form action="?action=handle_forgot_password" method="POST" class="space-y-6">
                ...
                <div class="space-y-2 relative group">
                    ...
                    <div class="relative">
                        <i class="fa-solid fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-primary transition-colors"></i>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Nhớ mật khẩu rồi? 
                    <a href="?action=login" class="text-primary font-semibold hover:text-yellow-600 transition underline decoration-2 decoration-primary/30 underline-offset-4 hover:decoration-yellow-600">
                        Đăng nhập ngay
                    </a>
                </p>
            </div>

<!-- ==================== HERO SECTION ==================== -->
<section id="hero" class="relative py-16 lg:py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        <div class="w-full lg:w-1/2 space-y-6 text-center lg:text-left" data-aos="fade-right" data-aos-duration="1000">
            <div class="inline-flex items-center gap-3 bg-white/5 dark:bg-gray-800/50 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 rounded-full px-2 py-2 pr-6 shadow-sm mb-2">
                <span class="bg-primary text-white text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg shadow-primary/30">Mới</span>
                <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">Nền tảng học lập trình số 1 Việt Nam</span>
                <i class="fa-solid fa-chevron-right text-gray-400 text-xs ml-1"></i>
            </div>
            
            <h1 class="text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 dark:text-white leading-[1.15] tracking-tighter mb-6">
                Nâng tầm kỹ năng <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-primary to-purple-600 dark:from-blue-400 dark:via-primary dark:to-purple-400 drop-shadow-sm">
                    Định hình tương lai
                </span>
            </h1>
            
            <p class="text-gray-600 dark:text-gray-400 text-lg sm:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
                Học lập trình không khó khi bạn có một <strong class="text-gray-900 dark:text-gray-200">lộ trình chuẩn</strong>. Khám phá hàng trăm khóa học từ cơ bản đến chuyên sâu, thực chiến với các dự án thực tế ngay hôm nay.
            </p>
            
            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-6">
                <a href="?action=courses" class="group relative flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-primary hover:from-primary hover:to-blue-600 text-white font-bold py-4 px-8 rounded-2xl shadow-[0_0_40px_rgba(37,99,235,0.3)] hover:shadow-[0_0_60px_rgba(37,99,235,0.5)] transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                    <span class="relative z-10">Khám phá khóa học</span>
                    <div class="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-300"></div>
                </a>
                <a href="#how-it-works" class="group flex items-center justify-center gap-2 bg-white/5 dark:bg-gray-800/30 backdrop-blur-md border border-gray-200 dark:border-gray-700 hover:border-primary/50 dark:hover:border-primary/50 hover:bg-gray-50 dark:hover:bg-gray-800/80 text-gray-700 dark:text-gray-200 font-bold py-4 px-8 rounded-2xl transition-all duration-300 hover:shadow-lg">
                    Tìm hiểu thêm
                    <i class="fa-solid fa-arrow-down group-hover:translate-y-1 transition-transform"></i>
                </a>
            </div>

            <div class="flex flex-wrap items-center gap-6 pt-10 justify-center lg:justify-start text-sm font-medium text-gray-600 dark:text-gray-400">
                <div class="flex items-center gap-3 group cursor-default">
                    <div class="w-10 h-10 rounded-xl bg-green-50 dark:bg-green-900/20 text-green-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <i class="fa-solid fa-shield-halved text-lg"></i>
                    </div>
                    <span>Bảo mật 100%</span>
                </div>
                <div class="flex items-center gap-3 group cursor-default">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                        <i class="fa-solid fa-headset text-lg"></i>
                    </div>
                    <span>Hỗ trợ 24/7</span>
                </div>
                <div class="flex items-center gap-3 group cursor-default">
                    <div class="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-900/20 text-purple-500 flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <div class="w-full lg:w-1/2 flex justify-center" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
            <div class="relative">
                ...
                <div class="rounded-3xl shadow-2xl w-full max-w-lg lg:max-w-full relative transform hover:rotate-1 transition-transform duration-500 bg-[#1e1e1e] border border-gray-700 overflow-hidden" style="aspect-ratio: 3/2;">
                    <!-- Window Controls -->
                    <div class="bg-[#2d2d2d] px-4 py-3 flex items-center gap-2 border-b border-gray-700">
                        <div class="w-3 h-3 rounded-full bg-red-500"></div>
                        <div class="w-3 h-3 rounded-full bg-yellow-500"></div>
                        <div class="w-3 h-3 rounded-full bg-green-500"></div>
                        <div class="mx-auto text-xs text-gray-400 font-mono absolute left-1/2 -translate-x-1/2">index.php</div>
                    </div>
                    <!-- Code Content -->
                    <div class="p-6 sm:p-8 lg:p-10 font-mono text-base sm:text-lg lg:text-xl leading-relaxed text-gray-300 h-full flex flex-col justify-center pb-16">
                        <div class="text-blue-400 font-bold mb-2">&lt;?php</div>
                        <div class="text-blue-400"><span class="text-purple-400">class</span> <span class="text-yellow-300">ELearning</span> {</div>
                        <div class="ml-4 sm:ml-8"><span class="text-purple-400">public function</span> <span class="text-blue-300">startJourney</span>() {</div>
                        <div class="ml-8 sm:ml-16"><span class="text-purple-400">return</span> <span class="text-green-400">"Tương lai bắt đầu từ đây!"</span>;</div>
                        <div class="ml-4 sm:ml-8">}</div>
                        <div class="ml-4 sm:ml-8 mt-2"><span class="text-purple-400">public function</span> <span class="text-blue-300">getSkills</span>() {</div>
                        <div class="ml-8 sm:ml-16"><span class="text-purple-400">return</span> [<span class="text-green-400">'Code'</span>, <span class="text-green-400">'Create'</span>, <span class="text-green-400">'Success'</span>];</div>
                        <div class="ml-4 sm:ml-8">}</div>
                        <div>}</div>
                        <div class="mt-4"><span class="text-blue-200">$student</span> = <span class="text-purple-400">new</span> <span class="text-yellow-300">ELearning</span>();</div>
                        <div><span class="text-blue-200">$student</span><span class="text-blue-400">-&gt;</span><span class="text-blue-300">startJourney</span>(); <span class="w-3 h-6 bg-gray-400 inline-block animate-pulse align-middle ml-1"></span></div>
                    </div>
                </div>
                ...
                <div class="absolute -bottom-12 -left-10 sm:-left-16 glass rounded-2xl shadow-xl p-4 animate-float" data-aos="zoom-in" data-aos-delay="800">
                    <div class="flex items-center gap-2">
...
<section id="how-it-works" class="py-20 w-full bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">Bắt đầu hành trình học tập của bạn chỉ với 3 bước đơn giản</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-700">
                    <div class="p-6 group hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="text-4xl font-extrabold text-gray-900 dark:text-white mb-2" 
                             x-data="{ count: 0, target: 10000, started: false }"
                             x-init="
                    ...
                    <div class="p-6 group hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="text-4xl font-extrabold text-gray-900 dark:text-white mb-2"
                             x-data="{ count: 0, target: 500, started: false }"
                             x-init="
                                let observer = new IntersectionObserver(entries => {
                                    if (entries[0].isIntersecting && !started) {
                                        started = true;
                    ...
                    <div class="p-6 group hover:scale-105 transition-transform duration-300">
                        ...
                        <div class="text-4xl font-extrabold text-gray-900 dark:text-white mb-2"
                             x-data="{ count: 0.0, target: 4.8, started: false }"
                             x-init="
                                let observer = new IntersectionObserver(entries => {
                                    if (entries[0].isIntersecting && !started) {
                                        started = true;
...
<section id="categories" class="py-20 w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative group px-2" x-data="{
            ...
            <button x-ref="prevBtn" class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 shadow-xl rounded-full w-12 h-12 flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary z-10 opacity-0 group-hover:opacity-100 transition-all duration-300">
                ...
                <div class="swiper-wrapper">
                    <?php foreach ($categories as $cat): ?>
                        <div class="swiper-slide !w-auto">
                            <a href="?action=courses&category=<?= $cat['id'] ?>" class="block w-40 sm:w-48 bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-2xl border border-gray-100 dark:border-gray-700 p-6 text-center transition-all duration-300 flex-shrink-0 group/card flex flex-col items-center justify-center hover:-translate-y-2 hover:border-primary/30">
            ...
            <button x-ref="nextBtn" class="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 shadow-xl rounded-full w-12 h-12 flex items-center justify-center hover:bg-primary hover:text-white hover:border-primary z-10 opacity-0 group-hover:opacity-100 transition-all duration-300">
...
<section id="featured-courses" class="py-20 w-full">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative mb-16">
            ...
            <a href="?action=courses" class="hidden md:flex items-center gap-2 text-primary font-semibold bg-primary/5 dark:bg-primary/10 px-6 py-3 rounded-xl hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors absolute right-0 bottom-0 group" data-aos="fade-left">
                    ...
                    <div class="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <div class="flex items-center justify-between border-t border-gray-100 dark:border-gray-700 pt-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button data-in-cart="<?= $in_cart ? 'true' : 'false' ?>" onclick="toggleCart(<?= $course['id'] ?>, this)" class="<?= $in_cart ? 'bg-primary text-white shadow-lg hover:bg-primary/90 hover:-translate-y-0.5' : 'bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-gray-200 hover:shadow-lg hover:-translate-y-0.5' ?> font-semibold py-2.5 px-4 rounded-xl transition-all duration-300 transform" title="<?= $in_cart ? 'Xóa khỏi giỏ hàng' : 'Thêm vào giỏ hàng' ?>">
...
<section id="paths" class="py-20 w-full bg-gradient-to-br from-primary/5 via-white to-blue-500/5 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 p-8 transition-all duration-300 card-hover text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="w-16 h-16 mx-auto bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <span class="text-xs font-bold px-3 py-1 bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 rounded-full"><i class="fa-solid fa-fire mr-1 text-orange-500"></i>Phổ biến</span>
                </div>
            </div>

            <div class="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 p-8 transition-all duration-300 card-hover text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="w-16 h-16 mx-auto bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <span class="text-xs font-bold px-3 py-1 bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 rounded-full"><i class="fa-solid fa-bolt mr-1 text-yellow-500"></i>Cơ hội cao</span>
                </div>
            </div>

            <div class="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 p-8 transition-all duration-300 card-hover text-center" data-aos="fade-up" data-aos-delay="300">
                <div class="w-16 h-16 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                    <i class="fa-solid fa-laptop-code text-3xl text-white"></i>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Fullstack Developer</h3>
                <div class="space-y-3 mb-6 inline-block text-left">
                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400"><i class="fa-solid fa-check-circle text-green-500"></i><span>MERN Stack</span></div>
                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400"><i class="fa-solid fa-check-circle text-green-500"></i><span>RESTful API & GraphQL</span></div>
                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400"><i class="fa-solid fa-check-circle text-green-500"></i><span>Web Security</span></div>
                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400"><i class="fa-solid fa-check-circle text-green-500"></i><span>System Design</span></div>
                </div>
                <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                    <span class="text-sm text-gray-500 dark:text-gray-400"><i class="fa-regular fa-clock mr-1"></i> 7 tháng</span>
                    <span class="text-xs font-bold px-3 py-1 bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400 rounded-full"><i class="fa-solid fa-rocket mr-1 text-pink-500"></i>Xu hướng</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if (!empty($topPosts)): ?>
                <?php foreach ($topPosts as $index => $post): ?>
                    <div class="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 relative flex flex-col h-full group hover:-translate-y-2" data-aos="fade-up" data-aos-delay="<?= $index * 100 ?>">
                        <!-- TIME (TOP LEFT) -->
                        <div class="absolute top-8 left-8 text-xs font-semibold text-gray-400 dark:text-gray-500 flex items-center gap-1 z-10">
                        ...
                        <div class="flex items-center gap-4 mt-auto pt-4 border-t border-gray-100 dark:border-gray-700 relative z-10">
                            <?php
                            $postAvatar = !empty($post['author_avatar'])
                                ? $post['author_avatar']
                                : 'https://ui-avatars.com/api/?name=' . urlencode($post['author_name']) . '&background=random';
                            ?>
                            <img src="<?= htmlspecialchars($postAvatar) ?>" alt="Avatar" class="w-14 h-14 rounded-2xl object-cover shadow-lg ring-4 ring-white dark:ring-gray-700">
                            <div class="flex-grow">
                                <h4 class="font-bold text-gray-900 dark:text-white"><?= htmlspecialchars($post['author_name']) ?></h4>
                                <?php if (isset($post['author_role']) && $post['author_role'] === 'student'): ?>
                                    <p class="text-xs text-primary font-medium mt-0.5">Học viên</p>
                                <?php endif; ?>
                            </div>
                            <a href="?action=forum_detail&id=<?= $post['id'] ?>" class="text-sm font-bold bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 transition-colors text-blue-600 dark:text-blue-400 px-3 py-1.5 rounded-xl flex items-center gap-1 shrink-0" title="Xem chi tiết">
...
<section id="contact-social" class="py-20 bg-slate-50 dark:bg-gray-900 relative overflow-hidden border-t border-gray-100 dark:border-gray-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-12" data-aos="fade-up">
            ...
            <p class="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">Liên hệ trực tiếp qua Hotline/Email hoặc cập nhật thông tin mới nhất trên các nền tảng mạng xã hội của E-Learning.</p>
        </div>
        
        <div class="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-6 sm:gap-10">
            <!-- Phone -->
            <a href="tel:0123456789" class="group flex flex-col items-center gap-4" data-aos="zoom-in" data-aos-delay="50">
            ...
            <!-- YouTube -->
            <a href="#" target="_blank" class="group flex flex-col items-center gap-4" data-aos="zoom-in" data-aos-delay="200">
            ...
            <!-- Zalo -->
            <a href="#" target="_blank" class="group flex flex-col items-center gap-4" data-aos="zoom-in" data-aos-delay="250">
                ...
                <span class="font-bold text-gray-700 dark:text-gray-300 group-hover:text-[#0068FF] transition-colors">Zalo OA</span>
            </a>
